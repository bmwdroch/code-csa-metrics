...
```
Репозиторий → Конвейер сборки → CSA Metrics (быстрый режим, 2--15 с) → Заключение
                                                                          │
                             ┌────────────────────────────────────────────┘
                             ▼
              Индекс ≤ порога: релиз допущен к развёртыванию
              Индекс > порога: перечень доработок передан команде
```
